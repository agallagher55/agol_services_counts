def get_map_data(my_items=False, owner='**', title='', access='', max_items=999, item_type='MAP'):
    """
    ...
    print(f"Running {get_map_data.__name__} function...")
    ...
    item_objs = gis.content.search(query=query, item_type=item_type, max_items=max_items, outside_org=False)
    data_objs = []
